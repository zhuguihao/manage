package com.thinkgem.manage.test.web;
...
import com.thinkgem.manage.test.entity.TestTree;
import com.thinkgem.manage.test.service.TestTreeService;
...
public class TestTreeController extends BaseController {
	...
	public String list(TestTree testTree, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "manage/test/testTreeList";
	}
	...
	public String form(TestTree testTree, Model model) {
		...
		return "manage/test/testTreeForm";
	}
